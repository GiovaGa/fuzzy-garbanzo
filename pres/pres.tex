...
\begin{frame}{Preliminary results}
  \begin{itemize}
    \item Preliminary results look promising: with small-size instances we get very small gap between ILP and SA solutions.
    \item Further testing on larger graphs and real-world cases is the next step.
  \end{itemize}
  \begin{center}
    \includegraphics[trim=0 0 225mm 0,clip,width=0.8\linewidth]{plot_graph.pdf}
  \end{center}
\end{frame}
